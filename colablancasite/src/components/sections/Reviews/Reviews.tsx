...
export function Reviews() {
    // Dos pistas con velocidades distintas para sensación cinemática
        ...
        <section id="resenas" className="relative bg-ink section-padding-lg">
              <div className="container-edge">
                      <div className="max-w-content">
                                <Eyebrow tone="muted">RESEÑAS</Eyebrow>Eyebrow>
...
/** Avatar con foto real si existe, iniciales como fallback */
function Avatar({ review, index }: { review: Review; index: number }) {
    ...
    // Número de avatar con padding: 01, 02, … 10
    ...
    return (
          <article className="relative w-[min(360px,80vw)] shrink-0 whitespace-normal rounded-lg border border-border bg-surface p-7">
                <div className="flex items-center gap-4">
                        ...
                        <div>
                                  <p className="font-body text-body-md font-semibold text-paper">
                                    {review.name}
                                  </p>p>
                                  <p className="font-body text-body-sm text-paper-muted">{review.city}</p>p>
                        </div>div>
                </div>div>
          
                <div
                          aria-label={`${review.rating} estrellas`}
                          className="mt-4 flex gap-1 text-neon"
                        >
                ...
                <p className="mt-4 font-body text-body-md leading-relaxed text-paper">
                  {review.body}
                </p>p>
