    ...
    <section id="servicios" className="relative bg-ink-deep section-padding-lg">
      <div className="container-edge">
        <div className="max-w-content">
          <Eyebrow tone="muted">NUESTROS SERVICIOS</Eyebrow>
          <SplitText
            as="h2"
            text="Seis servicios."
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-5 p-7">
        ...
        <p className="font-body italic text-body-md text-paper-muted">{service.tagline}</p>
        <ul className="mt-2 space-y-2">
          {service.bullets.map((b, i) => (
            <li key={i} className="flex items-start gap-3 font-body text-body-sm text-paper">
